...
function cloneWorkItemHierarchy (workItemId: number, parentWorkItemId: any = undefined) {
    return {
        execute : async () => {
            ...
            const wiFields = ['System.AreaId','System.AreaPath','System.TeamProject','System.NodeName','System.AreaLevel1','System.WorkItemType','System.Watermark','System.Title','System.Description','Microsoft.VSTS.Common.AcceptanceCriteria','Microsoft.VSTS.Common.Priority','Microsoft.VSTS.Scheduling.StoryPoints','Microsoft.VSTS.Common.ValueArea','Microsoft.VSTS.Common.Risk','Microsoft.VSTS.Scheduling.OriginalEstimate','Microsoft.VSTS.Scheduling.RemainingWork','Microsoft.VSTS.Scheduling.CompletedWork','Microsoft.VSTS.Scheduling.Effort','Microsoft.VSTS.Common.BusinessValue','Microsoft.VSTS.Common.TimeCriticality','Microsoft.VSTS.Scheduling.StartDate','Microsoft.VSTS.Scheduling.TargetDate'];
